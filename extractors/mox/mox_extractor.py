# from manual_ingestor import MoxExtractor
...
class MoxExtractor(AbstractExtractor):
    def __init__(self):
        ...
        self.prefix_nox = "nox"
        self.s3_client = boto3.client("s3")
        self.input_bucket_name = "s3-ingested-raw-data-prod"
        self.out_bucket_name = "s3-postprocess-data-prod"
        self.sheet_id_nox = "1A9JX0zH-GC6AlvoWDb9NxDEAM52HLBm2"
        self.sheet_id_mox = "1-AR-8pNEtfSangJ4pHxsj52TbUig9rUN"
...
def lambda_mox(event, context):
    print("this part is working")
    MoxExtractor().extract()
    return True